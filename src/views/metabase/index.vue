<template>
    ...
    <div>
        <Card class="p-6">
            <p class="font-medium lg:text-2xl text-xl capitalize text-slate-900 inline-block ltr:pr-4 rtl:pl-4">Credenciales</p>
            <p>Usuario: <span>{{ metabase.name }}</span></p>
            <p>Contraseña <span>{{ metabase.pass }}</span></p>
        </Card>
    </div>
</template>
